...
// Represents a writer that writes JSON representation of cataloguer to file
public class JsonWriter {
    ...
    public void write(ManhwaCatalogue mc) {
        ...
        model.EventLog.getInstance().logEvent(new model.Event("Saved list to " + destination));
    }
